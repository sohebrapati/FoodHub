...
namespace FoodHub
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/jsmasters").Include(
                        "~/Content/js/master.js"));

            bundles.Add(new ScriptBundle("~/bundles/jsscript_signin").Include(
                        "~/Content/plugins/jquery-slimscroll/jquery.slimscroll.js",
                        "~/Content/plugins/node-waves/waves.js",
                        "~/Content/plugins/jquery-countto/jquery.countTo.js",
            ...
            bundles.Add(new StyleBundle("~/bundles/css_signin").Include(
                      "~/Content/plugins/bootstrap/css/bootstrap.css",
                      "~/Content/plugins/node-waves/waves.css",
                      "~/Content/plugins/animate-css/animate.css",
                      "~/Content/css/materialize.css",
